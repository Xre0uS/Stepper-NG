...
public class DynamicGlobalVariablesPanel extends JPanel {
    ...
    public DynamicGlobalVariablesPanel(DynamicGlobalVariableManager manager) {
        ...
        dynamicTable.getColumnModel().getColumn(1).setPreferredWidth(300);
        dynamicTable.getColumnModel().getColumn(2).setPreferredWidth(150);
        dynamicTable.getColumnModel().getColumn(3).setPreferredWidth(200);
        ...
        JLabel dynamicLabel = new JLabel("  Dynamic Global Variables — Use $DVAR:name$ in requests. Auto-extracts from all HTTP responses via regex.");
    ...
    private void showAddDynamicDialog() {
        ...
        panel.add(new JLabel("Variable Name:"));
        panel.add(nameField);
        panel.add(new JLabel("Regex (group 1 captured):"));
        panel.add(regexField);
        panel.add(new JLabel("Host Filter (optional regex):"));
        panel.add(hostField);
    ...
    private class DynamicVarTableModel extends AbstractTableModel {
        private final String[] COLUMNS = {"Name ($DVAR:name$)", "Regex", "Host Filter", "Current Value"};
        ...
        public Object getValueAt(int row, int col) {
            ...
            return switch (col) {
                ...
                case 3 -> var.getValue() != null ? var.getValue() : "(no match yet)";
                default -> "";
            };
        }
    }
